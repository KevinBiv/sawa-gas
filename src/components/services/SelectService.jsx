...
import RequestTransportCardTopUp from "./Top up transport card/RequestTransportCardTopUp";
import RequestBusRent from "./Rent bus/RequestBusRent";
import RequestCarRent from "./Rent car/RequestCarRent";
import RequestFuelCardTopup from "./Top up Fuel card/RequestFuelCardTopup";
function SelectService({
  ...
  setOpenCarOderModel,
  openToUpOderModel,
  setOpenToUpOderModel,
  openFuelOderModel,
  setOpenFuelOderModel,
  openBusOderModel,
  setOpenBusOderModel,
}) {
  return (
